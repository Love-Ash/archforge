...
| W22 | Text crossed by a hairline rule shape: the divider's centerline passes through the glyph box, covering half the run (an unintended strikethrough; full profile only) | Move the text off the rule, or end the rule before it reaches the text |

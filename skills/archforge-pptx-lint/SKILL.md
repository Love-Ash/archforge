...
| W20 | Text drawn over a filled shape below it, under 2.0:1 contrast against that shape (a caption across chart bars, a footnote on a colored panel; XML colors and geometry, full profile only) | Move the text off the shape, or change either color to reach at least 2:1 |

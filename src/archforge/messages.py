...
MESSAGES = {
    ...
    "w22": {
        "ko": "글자가 가는 괘선을 관통하고 있습니다(글자 폭의 %.0f%%). 의도한 취소선이 아니라면 글자나 선을 옮겨 주세요",
    ...
    "fix_w22": {"ko": "글자를 선 밖으로 옮기거나, 괘선을 글자 앞에서 끝내세요", "en": "Move the text off the rule, or end the rule before it reaches the text"},

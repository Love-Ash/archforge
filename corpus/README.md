...
- `officecli/`: decks authored through the OfficeCLI binary (`gen_officecli.py`,
  OfficeCLI 1.0.135), a third-party .NET writer, covering every flagship error class
  plus geometry (E1-E4, W15, W16). The E1 fixture is OfficeCLI's own defaults: its
